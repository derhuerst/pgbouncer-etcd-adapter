...
const ETCD_ADDR = process.env.ETCD_ADDR || 'http://localhost:2379'
const etcdAddr = new URL(ETCD_ADDR)
strictEqual(etcdAddr.protocol, 'http:', `$ETCD_ADDR (${ETCD_ADDR}): invalid protocol`)
...
const ETCD_USER = etcdAddr.username || (etcdAddr.password ? 'root' : null)
